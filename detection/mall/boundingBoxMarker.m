...
handles.path2Folder = '/home/oong/Documents/cv/malldensity/detection/mall/mall_dataset/frames';
handles.imageID = 1;
handles.sID = 0;
handles.currentRow = 1;
handles.currentCol = 1;
handles.saveReminderCounter = 0;
name='groundtruth1800-2000.mat';
if (exist(name,'file'))
    load(name);
...
save(strcat('newOriData',handles.name_append,'.mat'),'newOriData');
guidata(hObject, handles);
