...
pDenPath=fullfile(opts.dtsetOpts.matDir,sprintf('%spDen%d.mat',opts.datasetName,opts.pDen.methodNo));
try
    load(pDenPath);
catch
    forestPath=fullfile(opts.dtsetOpts.matDir,sprintf('%sForest%s.mat',opts.datasetName,opts.pDen.methodNo));
